...
class Ui_ngv_mainwindow(object):
    def setupUi(self, ngv_mainwindow):
        ...
        self.widget1.setGeometry(QtCore.QRect(9, 10, 174, 238))
        ...
        self.spinBox_offset = QtWidgets.QSpinBox(self.widget1)
        ...
        self.spinBox_nrow = QtWidgets.QSpinBox(self.widget1)
        ...
        self.checkBox_autonrow = QtWidgets.QCheckBox(self.widget1)
        ...
        self.spinBox_padding = QtWidgets.QSpinBox(self.widget1)
        ...
        self.spinBox_drawrange_lower = QtWidgets.QSpinBox(self.widget1)
        ...
        self.spinBox_drawrange_upper = QtWidgets.QSpinBox(self.widget1)
