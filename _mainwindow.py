...
class Ui_ngv_mainwindow(object):
    def setupUi(self, ngv_mainwindow):
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 197, 368))
        self.page_3.setObjectName("page_3")
        self.layoutWidget = QtWidgets.QWidget(self.page_3)
        self.layoutWidget.setGeometry(QtCore.QRect(9, 10, 203, 331))
        ...
        self.label_displaysize = QtWidgets.QLabel(self.layoutWidget)
        self.label_displaysize.setObjectName("label_displaysize")
        self.verticalLayout_4.addWidget(self.label_displaysize)
        self.horizontalSlider_displaysize = QtWidgets.QSlider(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.horizontalSlider_displaysize.sizePolicy().hasHeightForWidth())
        self.horizontalSlider_displaysize.setSizePolicy(sizePolicy)
        self.horizontalSlider_displaysize.setMinimumSize(QtCore.QSize(180, 0))
        self.horizontalSlider_displaysize.setMouseTracking(True)
        self.horizontalSlider_displaysize.setMaximum(100)
        self.horizontalSlider_displaysize.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_displaysize.setObjectName("horizontalSlider_displaysize")
        self.verticalLayout_4.addWidget(self.horizontalSlider_displaysize)
        self.label_8 = QtWidgets.QLabel(self.layoutWidget)
        self.label_8.setObjectName("label_8")
        self.verticalLayout_4.addWidget(self.label_8)
        self.horizontalSlider_displayXpos = QtWidgets.QSlider(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.horizontalSlider_displayXpos.sizePolicy().hasHeightForWidth())
        self.horizontalSlider_displayXpos.setSizePolicy(sizePolicy)
        self.horizontalSlider_displayXpos.setMinimumSize(QtCore.QSize(180, 0))
        self.horizontalSlider_displayXpos.setMouseTracking(True)
        self.horizontalSlider_displayXpos.setMinimum(-200)
        self.horizontalSlider_displayXpos.setMaximum(200)
        self.horizontalSlider_displayXpos.setSliderPosition(0)
        self.horizontalSlider_displayXpos.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_displayXpos.setTickPosition(QtWidgets.QSlider.TicksAbove)
        self.horizontalSlider_displayXpos.setTickInterval(100)
        self.horizontalSlider_displayXpos.setObjectName("horizontalSlider_displayXpos")
        self.verticalLayout_4.addWidget(self.horizontalSlider_displayXpos)
        self.label_9 = QtWidgets.QLabel(self.layoutWidget)
        self.label_9.setObjectName("label_9")
        self.verticalLayout_4.addWidget(self.label_9)
        self.horizontalSlider_displayYpos = QtWidgets.QSlider(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.horizontalSlider_displayYpos.sizePolicy().hasHeightForWidth())
        self.horizontalSlider_displayYpos.setSizePolicy(sizePolicy)
        self.horizontalSlider_displayYpos.setMinimumSize(QtCore.QSize(180, 0))
        self.horizontalSlider_displayYpos.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.horizontalSlider_displayYpos.setMouseTracking(True)
        self.horizontalSlider_displayYpos.setMinimum(-200)
        self.horizontalSlider_displayYpos.setMaximum(200)
        self.horizontalSlider_displayYpos.setSliderPosition(0)
        self.horizontalSlider_displayYpos.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_displayYpos.setTickPosition(QtWidgets.QSlider.TicksAbove)
        self.horizontalSlider_displayYpos.setTickInterval(100)
        self.horizontalSlider_displayYpos.setObjectName("horizontalSlider_displayYpos")
        self.verticalLayout_4.addWidget(self.horizontalSlider_displayYpos)
        spacerItem = QtWidgets.QSpacerItem(20, 84, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_4.addItem(spacerItem)
        self.toolBox.addItem(self.page_3, "")
        self.page_4 = QtWidgets.QWidget()
        self.page_4.setGeometry(QtCore.QRect(0, 0, 189, 202))
    ...
    def retranslateUi(self, ngv_mainwindow):
        ...
        self.label_displaysize.setText(_translate("ngv_mainwindow", "Display size"))
        self.label_8.setText(_translate("ngv_mainwindow", "Display frame X position"))
        self.label_9.setText(_translate("ngv_mainwindow", "Display frame Y position"))
